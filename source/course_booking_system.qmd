...
The figures and workflow below show an overview **of the old booking system**. This **cannot be used for booking courses** anymore. However, the course overview can still be used to see which courses are available in what module. It is used here to showcase the example for the module "Location in GI Applications", because it actually gives a better overview than the new system.
